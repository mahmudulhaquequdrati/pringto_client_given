...
const OrderScreen = () => {
  ...
  const applyDiscount = () => {
    if(discountCode === "OFFER") {
      const discount = order.totalPrice * 0.1; // 10% discount
        ...
        <Col md={4}>
          <Card style={{ border: "1px solid grey" }}>
            <ListGroup variant="flush">
              ...
              <Row className="mt-3">
                <Col><label htmlFor="discountCode">Discount</label></Col>
                <Col>
                  <Form.Control
                    type="text"
                    id="discountCode"
              ...
              <Row>
                <Col>Total Price</Col>
                <Col>€ {adjustedTotal.toFixed(2)|| order.totalPrice.toFixed(2)}</Col>
              </Row>
              {!order.isPaid && (
                <ListGroup.Item
                  style={{
