      ...
      {isLoading ? (
        ...
        <>
          ...
          <Row>
            <Col md={5}>
              <Image
                // src={`https://printgo-backend-three.vercel.app/${products.image}`}
            ...
            <Col md={4}>
              <ListGroup variant="flush">
                ...
                >
                  ...
                  /> */}
                  <ul>
                    <li className="linh">{products.feature1}</li>
                    <li className="linh">{products.feature2}</li>
                    <li className="linh">{products.feature3}</li>
                    <li className="linh">{products.feature4}</li>
                  </ul>
                </ListGroup.Item>
                <ListGroup.Item
                  style={{
